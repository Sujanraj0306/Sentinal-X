...
export default function Sidebar({ cases, activeCase, onSelectCase, onCreateCase, onDeleteCase, currentView, setCurrentView }) {
     ...
     return (
          <div className="flex flex-col h-full w-full bg-gray-50 border-r-2 border-border font-sans">
               ...
               <div className="p-4 border-t-2 border-border bg-white flex flex-col gap-4">
                    <button
                         onClick={() => setCurrentView && setCurrentView('llm-search')}
                         className={`w-full py-3 px-4 flex items-center justify-center gap-2 font-bold uppercase tracking-widest text-sm transition-all border-2 border-black
                              ${currentView === 'llm-search'
                                   ? 'bg-black text-white shadow-none translate-x-1 translate-y-1'
                                   : 'bg-white text-black hover:bg-gray-100 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-0.5 hover:translate-y-0.5'
                              }`}
                    >
                         <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"></path></svg>
                         LLM Search
                    </button>
                    <div className="text-xs font-mono text-gray-400 text-center uppercase tracking-widest">
